...
<head>
	...
	<link rel=stylesheet href="{{ asset('Principal/css/main.css') }}">
	<!--[if lte IE 8]>
	<link rel=stylesheet href="css/ie.css">
	<![endif]-->
		<script src="{{ asset('Principal/js/vendor/modernizr.js') }}"></script>

		<script src="{{ asset('Principal/js/vendor/respond.min.js') }}"></script>
...
<body>
	<div class="level level-hero hero-home has-hint">
		...
		<!--video loop id=bg-video class=fullscreen-video>
			<source src="https://www.youtube.com/watch?v=OzvEZ4LBg_g" type="video/mp4">

		</video-->
		<img src="{{ asset('Principal/img/1.jpg') }}" alt class="mb-80 hidden-xs iphone-inline">
	...
	<div class=level>
		...
		<img src="{{ asset('Principal/img/v2/iphone6.min.png') }}" alt class="mb-80 hidden-xs iphone-inline">
	...
	<div class="level level-img-right">
		...
		<div class="container xs-mb-30">
			<img class=img-right-sprite src="{{ asset('Principal/img/v2/iphone-bg-lg.min.png') }}" alt>
		...
		<div class="visible-xs xs-mw xs-mb-40">
			<img src="{{ asset('Principal/img/v2/iphone-bg-lg.min.png') }}" alt>
		</div>
	...
	<script src="{{ asset('Principal/js/dropdown.js') }}"></script>
	<!--script src="{{ asset('Principal/js/modal.js') }}"></script>-->
